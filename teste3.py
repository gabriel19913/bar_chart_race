...
img = np.asarray(Image.open('/mnt/wsl/PHYSICALDRIVE1/bar_chart_race/data/background.png'))
...
df_images = pd.read_csv("/mnt/wsl/PHYSICALDRIVE1/bar_chart_race/data/df_images.csv")
